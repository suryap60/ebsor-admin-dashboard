  ...
  return (
    <div className="flex justify-between items-center p-6 border-t border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-950 rounded-b-2xl">
      ...
      <div className="flex items-center gap-1">
        ...
        <button className="cursor-pointer w-8 h-8 rounded-lg bg-[#3ABDE7] text-white font-medium flex items-center justify-center text-sm shadow-md shadow-indigo-600/20">
          {currentPage}
        </button>
