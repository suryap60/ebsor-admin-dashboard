        ...
        {faqs.map((faq, i) => (
          ...
          >
            ...
            <div className="flex-1 mt-2">
              <h3 className="text-lg font-semibold text-zinc-950 dark:text-white mb-1 group-hover:text-indigo-400 transition-colors">{faq.title}</h3>
            </div>
            ...
            <div className="flex items-center justify-between pt-4 border-t border-zinc-200 dark:border-zinc-800 mt-4">
              ...
              <div className="flex gap-1">
                ...
                <button onClick={(e) => { e.stopPropagation(); router.push(`/admin/faqs/edit/${faq._id}`); }} title="Edit" className="cursor-pointer p-2 text-zinc-600 dark:text-zinc-400 hover:text-indigo-400 hover:bg-indigo-500/10 rounded-lg transition-colors">
                  <Edit size={16} />
                </button>
