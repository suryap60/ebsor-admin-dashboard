      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-zinc-600 dark:text-zinc-400 text-sm">Reviewing application #{params.slug}</p>
          </div>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        >
          <div className="bg-white dark:bg-zinc-950 border border-zinc-200 dark:border-zinc-800 rounded-2xl p-6 md:p-8 space-y-6">
            <div className="flex items-start gap-4">
               ...
               <div>
                  <h2 className="text-xl font-bold text-zinc-950 dark:text-white">David Chen</h2>
                  <p className="text-zinc-600 dark:text-zinc-400 text-sm mt-1">Applying for <span className="font-medium text-zinc-950 dark:text-zinc-300">Senior Frontend Developer</span></p>
               </div>
            </div>

            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
               <div className="flex items-center gap-3 text-zinc-600 dark:text-zinc-400 text-sm">
                  <Mail size={16} /> david.chen@example.com
               </div>
               <div className="flex items-center gap-3 text-zinc-600 dark:text-zinc-400 text-sm">
                  <Phone size={16} /> +1 (555) 123-4567
               </div>
               <div className="flex items-center gap-3 text-zinc-600 dark:text-zinc-400 text-sm">
                  <Calendar size={16} /> Applied on Oct 24, 2026
               </div>
               <div className="flex items-center gap-3 text-zinc-600 dark:text-zinc-400 text-sm">
        ...
        >
          <div className="bg-white dark:bg-zinc-950 border border-zinc-200 dark:border-zinc-800 rounded-2xl p-6">
            ...
            <select defaultValue="new" className="w-full bg-zinc-100 dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-xl px-4 py-3 text-zinc-950 dark:text-white focus:outline-none focus:border-indigo-500 transition-all">
          ...
          <div className="bg-white dark:bg-zinc-950 border border-zinc-200 dark:border-zinc-800 rounded-2xl p-6">
            ...
            <div className="border border-zinc-200 dark:border-zinc-800 rounded-xl p-4 flex items-center justify-between group hover:border-indigo-500 transition-colors">
               ...
               <button className="text-zinc-400 hover:text-indigo-600 dark:hover:text-indigo-400 transition-colors p-2">
                  <Download size={18} />
               </button>
            </div>
          </div>
