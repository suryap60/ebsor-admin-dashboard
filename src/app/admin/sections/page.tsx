  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-2xl font-bold text-zinc-950 dark:text-white mb-2">Policies & FAQs</h1>
          <p className="text-zinc-600 dark:text-zinc-400 text-sm">Manage Terms, Privacy Policies, and FAQs.</p>
        </div>
          ...
          >
            ...
            <div className="flex items-center justify-between pt-4 border-t border-zinc-200 dark:border-zinc-800 mt-4">
              ...
              <div className="flex gap-1">
                <button onClick={(e) => { e.stopPropagation(); router.push(`/admin/sections/${section._id}`); }} title="View Details" className="p-2 cursor-pointer rounded-lg transition-colors text-zinc-600 dark:text-zinc-400 hover:text-amber-400 hover:bg-amber-500/10">
                  <Eye size={16} />
                </button>
                <button onClick={(e) => { e.stopPropagation(); router.push(`/admin/sections/edit/${section._id}`); }} title="Edit" className="cursor-pointer p-2 text-zinc-600 dark:text-zinc-400 hover:text-indigo-400 hover:bg-indigo-500/10 rounded-lg transition-colors">
                  <Edit size={16} />
                </button>
