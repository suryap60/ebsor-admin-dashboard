          ...
          >
            ...
            <div className="flex items-center justify-between pt-4 border-t border-zinc-200 dark:border-zinc-800 mt-4">
              ...
              <div className="flex gap-1">
                ...
                <button onClick={(e) => { e.stopPropagation(); router.push(`/admin/sections/edit/${section._id}`); }} title="Edit" className="cursor-pointer p-2 text-zinc-600 dark:text-zinc-400 hover:text-[#3ABDE7]/80 hover:bg-[#3ABDE7]/10 rounded-lg transition-colors">
                  <Edit size={16} />
                </button>
