    ...
    <div className="min-h-screen bg-zinc-50 dark:bg-[#f8f9fa] dark:bg-black flex items-center justify-center p-4 relative overflow-hidden">
      ...
      >
        <div className="text-center mb-8">
          ...
          <p className="text-zinc-600 dark:text-zinc-400 text-sm">Sign in to your Admin CMS account</p>
        </div>
        ...
        <form onSubmit={handleLogin} className="space-y-4">
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full bg-indigo-600 hover:bg-indigo-500 text-zinc-950 dark:text-white rounded-xl py-3 font-medium transition-colors mt-6 flex items-center justify-center gap-2 group disabled:opacity-50 disabled:cursor-not-allowed"
          >
